...
L         =  1.25*D;              % chamber width (equal to h for 1-D mode) [m]
...
mulim     =  1e-5;                % Setting a limint for melt fraction

% set initial thermo-chemical state
init_mode =  'MOR';
T0        =  5;                   % temperature top  layer [deg C]
T1        =  1375;                % temperature base layer [deg C]
c0        =  [0.83 0.17 0];    % components (maj comp, H2O) top  layer [wt] (will be normalised to unit sum!)
